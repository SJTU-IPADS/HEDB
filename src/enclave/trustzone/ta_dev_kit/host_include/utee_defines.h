...
#else
#define TEE_U64_BSWAP(x) ((uint64_t)((((uint64_t)(x)&UINT64_C(0xff00000000000000ULL)) >> 56) | (((uint64_t)(x)&UINT64_C(0x00ff000000000000ULL)) >> 40) | (((uint64_t)(x)&UINT64_C(0x0000ff0000000000ULL)) >> 24) | (((uint64_t)(x)&UINT64_C(0x000000ff00000000ULL)) >> 8) | (((uint64_t)(x)&UINT64_C(0x00000000ff000000ULL)) << 8) | (((uint64_t)(x)&UINT64_C(0x0000000000ff0000ULL)) << 24) | (((uint64_t)(x)&UINT64_C(0x000000000000ff00ULL)) << 40) | (((uint64_t)(x)&UINT64_C(0x00000000000000ffULL)) << 56)))
#endif

#ifdef __compiler_bswap32
#define TEE_U32_BSWAP(x) __compiler_bswap32((x))
#else
#define TEE_U32_BSWAP(x) ((uint32_t)((((uint32_t)(x)&UINT32_C(0xff000000)) >> 24) | (((uint32_t)(x)&UINT32_C(0x00ff0000)) >> 8) | (((uint32_t)(x)&UINT32_C(0x0000ff00)) << 8) | (((uint32_t)(x)&UINT32_C(0x000000ff)) << 24)))
#endif

#ifdef __compiler_bswap16
#define TEE_U16_BSWAP(x) __compiler_bswap16((x))
#else
#define TEE_U16_BSWAP(x) ((uint16_t)((((uint16_t)(x)&UINT16_C(0xff00)) >> 8) | (((uint16_t)(x)&UINT16_C(0x00ff)) << 8)))
#endif
...
#define TEE_TIME_LT(t1, t2) \
    (((t1).seconds == (t2).seconds) ? ((t1).millis < (t2).millis) : ((t1).seconds < (t2).seconds))

#define TEE_TIME_LE(t1, t2) \
    (((t1).seconds == (t2).seconds) ? ((t1).millis <= (t2).millis) : ((t1).seconds <= (t2).seconds))

#define TEE_TIME_ADD(t1, t2, dst)                    \
    do {                                             \
