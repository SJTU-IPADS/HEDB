    ...
    (__extension__({                                                                                         \
        ...
        if (__builtin_constant_p((unsigned long long)__high)                                                 \
            ...
            __asm__ volatile(                                                                                \
                ...
                "hint\t#0x14 // CSDB" /* The value we have loaded, or failval if the condition check         \
                                         fails.  */                                                          \
                : [__v] "=&r"(__nln_val) /* The pointer we wish to use for comparisons, and the low and      \
                                            high bounds to use in that comparison. Note that this need       \
                                            not be the same as the pointer from which we will load.  */      \
                : [__c] "r"(__cmpptr), [__l] "r"(__low), /* The memory location from which we will load.  */ \
                [__p] "m"(*(__ptr)), /* The value to return if the condition check fails.  */                \
                [__f] "rZ"(__fv) /* We always clobber the condition codes.  */                               \
                : "cc");                                                                                     \
        } else {                                                                                             \
            __asm__ volatile(                                                                                \
                "cmp\t%[__c], %[__l]\n\t"                                                                    \
                ...
                [__h] "r"(__high), /* The memory location from which we will load.  */                       \
                [__p] "m"(*(__ptr)), /* The value to return if the condition check fails.  */                \
                [__f] "rZ"(__fv) /* We always clobber the condition codes.  */                               \
                : "cc");                                                                                     \
        }                                                                                                    \
    ...
    (__extension__({                                                                                         \
        ...
        if (__builtin_constant_p((unsigned long)__high)                                                      \
            ...
            __asm__ volatile(                                                                                \
                ...
                "movcc\t%[__v], %[__f]\n\t"                                                                  \
                ".inst.n 0xf3af\t@ CSDB\n\t"                                                                 \
                ".inst.n 0x8014\t@ CSDB" /* The value we have loaded, or failval if the condition check      \
                                            fails.  */                                                       \
                : [__v] "=&l"(__nln_val) /* The pointer we wish to use for comparisons, and the low and      \
                                            high bounds to use in that comparison. Note that this need       \
                                            not be the same as the pointer from which we will load.  */      \
                : [__c] "r"(__cmpptr), [__l] "r"(__low), /* The memory location from which we will load.  */ \
                [__p] "m"(*(__ptr)), /* The value to return if the condition check fails.  */                \
                [__f] "r"(__fv) /* We always clobber the condition codes.  */                                \
                : "cc");                                                                                     \
        } else {                                                                                             \
            __asm__ volatile(                                                                                \
                ".syntax unified\n\t"                                                                        \
        ...
        if (__builtin_constant_p((unsigned long)__high)                                                      \
            ...
            __asm__ volatile(                                                                                \
                ...
                : [__v] "=&l"(__nln_val) /* The pointer we wish to use for comparisons, and the low and      \
                                            ...
                                            not be the same as the pointer from which we will load.  */      \
                : [__c] "r"(__cmpptr), [__l] "r"(__low), /* The memory location from which we will load.  */ \
                [__p] "r"(__ptr), /* The value to return if the condition check fails.  */                   \
                [__f] "r"(__fv) /* We always clobber the condition codes.  */                                \
                : "cc");                                                                                     \
        } else {                                                                                             \
            __asm__ volatile(                                                                                \
    ...
    (__extension__({                                                                                         \
        ...
        if (__builtin_constant_p((unsigned long)__high)                                                      \
            ...
            __asm__ volatile(                                                                                \
                ...
                "ldr" __sz "cs\t%[__v], %[__p]\n\t"                                                          \
                "movcc\t%[__v], %[__f]\n\t"                                                                  \
                ".inst 0xe320f014\t@ CSDB" /* The value we have loaded, or failval if the condition check    \
                                              fails.  */                                                     \
                : [__v] "=&r"(__nln_val) /* The pointer we wish to use for comparisons, and the low and      \
                                            high bounds to use in that comparison. Note that this need       \
                                            not be the same as the pointer from which we will load.  */      \
                : [__c] "r"(__cmpptr), [__l] "r"(__low), /* The memory location from which we will load.  */ \
                [__p] "m"(*(__ptr)), /* The value to return if the condition check fails.  */                \
                [__f] "rKI"(__fv) /* We always clobber the condition codes.  */                              \
                : "cc");                                                                                     \
        } else {                                                                                             \
            __asm__ volatile(                                                                                \
                ".syntax unified\n\t"                                                                        \
