...
#define __INTOF_ASSIGN(dest, src) (__extension__({                                                                                \
    ...
    (((uintmax_t)__intof_x == (uintmax_t)__intof_y) && ((__intof_x < 1) == (__intof_y < 1)) ? (void)((dest) = __intof_y), 0 : 1); \
}))
...
#define __INTOF_ADD(c, a, b) (__extension__({                                                                                                                        \
    ...
    uintmax_t __intofa_b_unsigned = __intofa_b;                                                                                                                      \
                                                                                                                                                                     \
    __intofa_b < 1       ? __intofa_a < 1 ? ((INTMAX_MIN - __intofa_b_signed <= __intofa_a_signed)) ? __INTOF_ASSIGN((c), __intofa_a_signed + __intofa_b_signed) : 1 \
                                          : ((__intofa_a_unsigned >= (uintmax_t)-__intofa_b) ? __INTOF_ASSIGN((c), __intofa_a_unsigned + __intofa_b_signed)          \
                                                                                             : __INTOF_ASSIGN((c),                                                   \
                                                                                                 (intmax_t)(__intofa_a_unsigned + __intofa_b_signed)))               \
              : __intofa_a < 1 ? ((__intofa_b_unsigned >= (uintmax_t)-__intofa_a) ? __INTOF_ASSIGN((c), __intofa_a_signed + __intofa_b_unsigned)                     \
                                                                                  : __INTOF_ASSIGN((c),                                                              \
                                                                                      (intmax_t)(__intofa_a_signed + __intofa_b_unsigned)))                          \
                         : ((UINTMAX_MAX - __intofa_b_unsigned >= __intofa_a_unsigned) ? __INTOF_ASSIGN((c), __intofa_a_unsigned + __intofa_b_unsigned) : 1);        \
}))
...
#define __INTOF_SUB(c, a, b) (__extension__({                                                                                                                          \
    ...
    uintmax_t __intofs_b_unsigned = __intofs_b;                                                                                                                        \
                                                                                                                                                                       \
    __intofs_b < 1       ? __intofs_a < 1 ? ((INTMAX_MAX + __intofs_b_signed >= __intofs_a_signed) ? __INTOF_ASSIGN((c), __intofs_a_signed - __intofs_b_signed) : 1)   \
                                          : (((uintmax_t)(UINTMAX_MAX + __intofs_b_signed) >= __intofs_a_unsigned) ? __INTOF_ASSIGN((c), __intofs_a - __intofs_b) : 1) \
        : __intofs_a < 1 ? (((intmax_t)(INTMAX_MIN + __intofs_b) <= __intofs_a_signed) ? __INTOF_ASSIGN((c),                                                           \
                                (intmax_t)(__intofs_a_signed - __intofs_b_unsigned))                                                                                   \
                                                                                       : 1)                                                                            \
                         : ((__intofs_b_unsigned <= __intofs_a_unsigned) ? __INTOF_ASSIGN((c), __intofs_a_unsigned - __intofs_b_unsigned)                              \
                                                                         : __INTOF_ASSIGN((c),                                                                         \
                                                                             (intmax_t)(__intofs_a_unsigned - __intofs_b_unsigned)));                                  \
}))
...
#define __intof_mul_t (__intof_mul_a1 * __intof_mul_b0 + __intof_mul_a0 * __intof_mul_b1)
...
#define __INTOF_MUL(c, a, b) (__extension__({                                                                                                                                                                                          \
    ...
    typeof(c) __intof_c;                                                                                                                                                                                                               \
                                                                                                                                                                                                                                       \
    __intof_oa == 0 || __intof_ob == 0 || __intof_oa == 1 || __intof_ob == 1 ? __INTOF_ASSIGN((c), __intof_oa* __intof_ob) : (__intof_mul_a0 && __intof_mul_b0) || __intof_mul_t > __intof_mul_hmask ? 1                               \
        : __INTOF_ADD((__intof_c), __intof_mul_t << __intof_mul_hshift, __intof_mul_a1 * __intof_mul_b1)                                                                                             ? 1                               \
